...
public class EmplacementsDAO extends DAO<Emplacements> {
    ...
    public Integer nbEmplacement(){
    	try {
		ResultSet compteur = this.connect.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY).executeQuery("SELECT Count DISTINCT (*) as count FROM Emplacement");
