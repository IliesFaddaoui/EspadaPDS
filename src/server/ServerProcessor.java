		...
		while(!sock.isClosed()){
			try{
				...
				case "FINDCHIFFREDAFFAIRES":
					...
					//the server read the data
					String toFindC = read();
					System.out.println("DonnÈe reÁue sur le server: "+toFindC);
				...
				case "FINDMAGASIN":
					...
					//the server read the data
					String toFindM = read();
					System.out.println("DonnÈe reÁue sur le server: "+toFindM);
				...
				case "FINDRETOUR":
					...
					//the server read the data
					String toFindR = read();
					System.out.println("DonnÈe reÁue sur le server: "+toFindR);
				...
				case "FINDPRODUCT":
					...
					//the server read the data
					String toFindP = read();
					System.out.println("DonnÈe reÁue sur le server: "+toFindP);
