					...
					try {
						...
						if (bonLivraison != null) {
							...
							for (int i = 0; i < listProduits.length; ++i) {
								...
								System.out.println("Stock trouv� !");
								...
								System.out.println("motif" + stockToUpdate.getMotifEntree());
									...
									messageToclient = "Aucun stock trouv� pour le produit ayant comme id: "+ listProduits[i]+ "..Veuillez v�rifier les informations entrees!";
									writer.write(messageToclient);
									writer.flush();
									break;
							...
							messageToclient = "Bon de Livraison erronne..Veuillez v�rifier les informations entrees!";
							writer.write(messageToclient);
							writer.flush();
							break;
