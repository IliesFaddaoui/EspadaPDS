...
/**
 * 
 * @author aramil: View for delivery notes management
 *
 */
...
public class StockEntryView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StockEntryView frame = new StockEntryView();
	...
	private class BoutonLivraison implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (bonLivraison != null) {
				System.out.println("Bon de livraison trouvÃ©.. Recherche des produits associés");
				...
				for (int i = 0; i < listProduits.length; ++i) {
					...
					stockToUpdate.setMotifEntree(motifSortie);
